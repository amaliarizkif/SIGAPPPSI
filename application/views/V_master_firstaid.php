    ...
    <div class="row mb-4">
      ...
      <div class="col-lg-12" style="padding: 0px;">
        <a href="<?php echo base_url(); ?>Master/add_firstaid">
          <button type="button" class="btn btn-add"> <i class="mdi mdi-plus"></i>Add First Aid Guide
          </button>
        </a>
        <a href="<?php echo base_url(); ?>Master/ExportFirstAid">
            ...
            <?php foreach ($fa as $f){ ?>
              <tr>
                ...
                <td style="text-align: center;" >
                  <a href="<?php echo base_url(); ?>Master/edit_firstaid/<?php echo $f['ID_FAG']?>"><button class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                  <button class="btn btn-danger" onclick="delFA(<?php echo $f['ID_FAG']?>)"><i class="fa fa-trash" aria-hidden="true"></i></button>
                </td>
              </tr>
            <?php } ?>
          </tbody>

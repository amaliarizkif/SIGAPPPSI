  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-9 order-1 order-lg-2">
        <form action="<?php echo base_url()?>Emergency/edit_emergencycall/<?php echo $ec->ID_ECL;?>" method="POST"  enctype="multipart/form-data">
          ...
          <div class="row mt-3 mb-3">
            ...
            <div class="col-md-9 col-sm-9">
              <textarea class="form-control" name="Summary" required><?php echo $ec->Summary;?></textarea>
            </div>
          </div>
          <div class="row mt-3 mb-3">
            <div class="col-md-3 col-sm-3">
            ...
            <div class="col-md-9 col-sm-9">
              <input type="file"  accept=".png,.jpeg,.jpg" class="form-control" maxlength="50" name="File">

...
<main id="main">
  ...
  <section id="about" class="about">
    <div class="container">
      ...
      <div class="row">
       <!--  <iframe src="https://docs.google.com/gview?url=http://localhost/SIGAPPPSI/assets/files/denah.pdf&embedded=true" style="display: block; width: 100%; height: 400px; border: none;"></iframe> -->

        <object style="position: relative; width: 80%; height:400px;" type="application/pdf" data="<?php echo base_url();?>assets/files/denah.pdf?#zoom=85&scrollbar=0&toolbar=0&navpanes=0">

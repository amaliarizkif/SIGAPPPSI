  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-9 order-1 order-lg-2">
        <form action="<?php echo base_url()?>Emergency/edited_doctorconsul/<?php echo $this->uri->segment(3)?>" method="POST"  enctype="multipart/form-data">
          ...
          <div class="row mt-3 mb-3">
            ...
            <div class="col-md-9 col-sm-9">
              <input type="file" class="form-control" accept=".png,.jpg,.jpeg,.pdf" name="Receipt" required>
            </div>
          </div>
